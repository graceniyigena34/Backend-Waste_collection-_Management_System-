 ...
 */
router.get("/me", auth_1.authenticate, scheduleController_1.getMySchedules);
/**
 * @swagger
 ...
 */
router.get("/driver", auth_1.authenticate, scheduleController_1.getDriverSchedules);
/**
 * @swagger
 * /api/schedules:
 *   get:
 ...
 */
router.get("/", auth_1.authenticate, auth_1.authorizeAdmin, scheduleController_1.listAllSchedules);
/**
 * @swagger
 * /api/schedules:
 *   post:
 ...
 */
router.post("/", auth_1.authenticate, auth_1.authorizeAdmin, scheduleController_1.createCollectionSchedule);
/**
 * @swagger
 ...
 */
router.patch("/:id/status", auth_1.authenticate, scheduleController_1.patchScheduleStatus);
/**
 * @swagger
 * /api/schedules/{id}:
 *   delete:
 ...
 */
router.delete("/:id", auth_1.authenticate, auth_1.authorizeAdmin, scheduleController_1.removeSchedule);
